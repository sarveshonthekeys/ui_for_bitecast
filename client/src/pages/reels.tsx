...
export default function ReelsPage() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-4 bottom-56 z-20 flex flex-col items-center gap-6">
      ...
      <div className="absolute left-0 bottom-32 z-10 p-4 pr-20 w-full text-white">
