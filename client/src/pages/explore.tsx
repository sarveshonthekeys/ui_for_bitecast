    ...
    <div className="pb-24 pt-4 px-4 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        {DISCOVERY_CARDS.map((card, i) => (
          ...
          >
            {card.img && <img src={card.img} alt="" className="absolute inset-0 w-full h-full object-cover opacity-60 mix-blend-overlay transition-transform duration-500 group-hover:scale-110" />}
